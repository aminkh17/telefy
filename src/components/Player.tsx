...
import { AppleGlassEffect } from "@/components/ui/AppleGlassEffect";
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 z-50">
            <AppleGlassEffect
                ...
                blur={30} // Map blurIntensity="xl" to a numerical blur value
                opacity={0.35} // Map backgroundOpacity={70} to this component's opacity scale
                tint="vibrant" // Use vibrant tint for cyberpunk feel
                border={false} // Use border prop
                hover={false} // Disable hover effects on the player bar
            >
